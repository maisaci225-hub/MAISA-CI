...
import ShareButtonsCompact from "./ShareButtonsCompact";
interface MediaItem {
  type: "image" | "video";
  src: string;
  thumbnail?: string;
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
              {images.map((image, index) => (
                ...
                >
                  ...
                  {/* Share buttons under each image */}
                  <div className="mt-2 py-2 bg-muted/50 rounded-lg">
                    <ShareButtonsCompact 
                      title={image.alt}
                      text={`Découvrez cette photo: ${image.alt} - MAISA-CI`}
                    />
                  </div>
                </motion.div>
              ))}
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
              {videos.map((video, index) => (
                <motion.div
                  ...
                  className="flex flex-col"
                >
                  <div className="group relative aspect-video overflow-hidden rounded-xl shadow-elegant">
                  ...
                  {/* Share buttons under each video */}
                  <div className="mt-2 py-2 bg-muted/50 rounded-lg">
                    <ShareButtonsCompact 
                      title={video.alt}
                      text={`Regardez cette vidéo: ${video.alt} - MAISA-CI`}
                    />
                  </div>
                </motion.div>
              ))}
